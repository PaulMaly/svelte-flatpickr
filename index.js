(function (global, factory) {
	...
	(global = global || self, factory(global.flatpickr = {}));
	...
	function flatpickr$1(node, options) {
		...
		return {
			c() {
				...
				dispose = [
					...
					listen(input, "destroy", ctx.destroy_handler),
					listen(input, "position", ctx.position_handler)
				];
			},

			m(target, anchor) {
				insert(target, input, anchor);
				flatpickr_action = flatpickr$1.call(null, input, ctx.opts) || {};
			},
